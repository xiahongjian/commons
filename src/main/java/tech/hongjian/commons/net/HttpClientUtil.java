...
public class HttpClientUtil {
    ...
    private final static int connectTimeouts = 30000;
    private final static int keepAliveMillSec = 30000;

    public static final String CONTENT_TYPE_URLENCODED = "application/x-www-form" +
            "-urlencoded";
        ...
        try {
            ...
            Registry<ConnectionSocketFactory> socketFactoryRegistry =
                    RegistryBuilder.<ConnectionSocketFactory>create()
                            .register("http", PlainConnectionSocketFactory.INSTANCE).register(
                            "https", new
            ...
            httpClient =
                    HttpClients.custom().setConnectionManager(connManager).setKeepAliveStrategy(keepAliveStrategy)
                            .build();
            // 创建socket配置实例
            ...
            MessageConstraints messageConstraints =
                    MessageConstraints.custom().setMaxHeaderCount(200).setMaxLineLength
                            (2000).build();
            // 创建连接池配置实例
    ...
    public static String get(String url, Map<String, String> params, String encode,
                             int timeout, String username, String password) throws Exception {
        URI uri =
                new URIBuilder(url).addParameters(params.entrySet().stream().map(e -> new BasicNameValuePair(e.getKey(), e.getValue())).collect(Collectors.toList()))
                        .build();
    ...
    public static String get(String url, Map<String, String> params, String username,
        ...
        return get(url, params, DEFAULT_ENCODING, connectTimeouts, username, password);
    }

    public static String get(String url, Map<String, String> params) throws Exception {
        return get(url, params, DEFAULT_ENCODING, connectTimeouts, null, null);
    }

    public static String get(String url, String username, String password) throws Exception {
        return get(url, Collections.emptyMap(), DEFAULT_ENCODING, connectTimeouts,
                username, password);
    }

    public static String get(String url) throws Exception {
        return get(url, Collections.emptyMap(), DEFAULT_ENCODING, connectTimeouts, null
                , null);
    }
     ...
     * @return 返回数据结果字符串
     */
    public static String post(String url, int timeout, String postData,
                              String contentType, String encoding, String
        ...
        post.setConfig(buildRequestConfig(timeout == 0 ? connectTimeouts : timeout));
    ...
    public static String post(String url, String data, String contentType,
        ...
        return post(url, connectTimeouts, data, contentType, DEFAULT_ENCODING, username
                , password);
    }

    public static String post(String url, String data, String contentType) throws Exception {
        return post(url, connectTimeouts, data, contentType, DEFAULT_ENCODING, null,
                null);
    }

    public static String post(String url, String data) throws Exception {
        return post(url, connectTimeouts, data, CONTENT_TYPE_URLENCODED,
                DEFAULT_ENCODING, null, null);
    }

    public static String post(String url, String data, String username,
                              String password) throws Exception {
        return post(url, connectTimeouts, data, CONTENT_TYPE_URLENCODED,
                DEFAULT_ENCODING, username, password);
    }

    public static String post(String url) throws Exception {
        return post(url, connectTimeouts, null, CONTENT_TYPE_URLENCODED,
                DEFAULT_ENCODING, null, null);
    }
     ...
     * @return 返回数据结果字符串
     */
    public static String put(String url, int timeout, String data,
                             String contentType, String encoding, String
                                     username, String password) throws Exception {
        ...
        RequestConfig requestConfig = buildRequestConfig(timeout == 0 ?
    ...
    public static String authorization(String username, String password) {
        return "Basic " + new BASE64Encoder().encode((username + ":" + password).getBytes(Consts.UTF_8));
    }
}
